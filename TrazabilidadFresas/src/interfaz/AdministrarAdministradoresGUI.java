 ...
 * @author fredy
 */
public class AdministrarAdministradoresGUI extends javax.swing.JFrame {

    /**
     * Creates new form AdministrarAdministradoresGUI
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdministrarAdministradoresGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdministrarAdministradoresGUI().setVisible(true);
            }
        });
    }
