 ...
 * @author fredy
 */
public class CRUDPlagaGUI extends javax.swing.JFrame {

    /**
     * Creates new form CRUDPlagaGUI
     */
    private boolean editing = false;
    private int filaEditable = -1;
    private ArrayList plagas = new ArrayList();
    ...
    public CRUDPlagaGUI() {
        ...
        plagasTable.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                int fila = plagasTable.rowAtPoint(e.getPoint());
                int columna = plagasTable.columnAtPoint(e.getPoint());
                    ...
                    if (filaEditable != -1 && fila == filaEditable) {
                        ...
                        switch (columna) {
                            case 0:
                                ...
                                break;
                            case 1:
                                mensaje = "Ingrese la maxima valoracion";
                                break;
                        }
                        String m = JOptionPane.showInputDialog(mensaje);
                        plagasTable.setValueAt(m, fila, columna);
                    }
                }
            }
        });
    ...
    private void initComponents() {
        ...
        plagasTable = new javax.swing.JTable();
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Plagas", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 14), new java.awt.Color(0, 0, 153))); // NOI18N
        ...
        plagasTable.setBackground(new java.awt.Color(204, 204, 255));
        plagasTable.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        plagasTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Nombre", "Maxima Valoracion"
            }
        ) {
        ...
        plagasTable.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        plagasTable.getTableHeader().setReorderingAllowed(false);
        jScrollPane1.setViewportView(plagasTable);
        if (plagasTable.getColumnModel().getColumnCount() > 0) {
            plagasTable.getColumnModel().getColumn(0).setResizable(false);
            plagasTable.getColumnModel().getColumn(1).setResizable(false);
        }
    ...
    private void borrarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_borrarButtonActionPerformed
        // TODO add your handling code here:
        if (plagasTable.getSelectedRow() > -1) {
            Plaga p = (Plaga) plagas.get(plagasTable.getSelectedRow());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CRUDPlagaGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CRUDPlagaGUI().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable plagasTable;
