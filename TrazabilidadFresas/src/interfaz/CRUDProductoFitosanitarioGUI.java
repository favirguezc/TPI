...
public class CRUDProductoFitosanitarioGUI extends javax.swing.JFrame {
    ...
    private void borrarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_borrarButtonActionPerformed
        ...
        if (equipoDeAplicacionesFitosanitariasTable.getSelectedRow() > -1) {
            ProductoFitosanitario a = (ProductoFitosanitario) equipoDeAplicacionesFitosanitarias.get(equipoDeAplicacionesFitosanitariasTable.getSelectedRow());
    ...
    private void guardarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarButtonActionPerformed
        ...
        try {
            ...
            lc.setIngrediente_activo((String) equipoDeAplicacionesFitosanitariasTable.getValueAt(filaEditable, 1));
    ...
    private void cargarTabla() {
        DefaultTableModel modelo = (DefaultTableModel) equipoDeAplicacionesFitosanitariasTable.getModel();
        equipoDeAplicacionesFitosanitarias = (ArrayList) new ProductoFitosanitarioControl().leerTodos();
        for (int i = 0; i < equipoDeAplicacionesFitosanitarias.size(); i++) {
            ProductoFitosanitario a = (ProductoFitosanitario) equipoDeAplicacionesFitosanitarias.get(i);
